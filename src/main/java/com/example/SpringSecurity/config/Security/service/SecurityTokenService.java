...
import com.example.SpringSecurity.utils.UUID;
...
import com.example.SpringSecurity.config.Redis.RedisCache;
...
public class SecurityTokenService {
    ...
    public UserInfo getLoginUser(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(token)) {
            ...
            UserInfo user = redisCache.getCacheObject(userKey);
...
//        setUserAgent(loginUser);
     ...
     * @param loginUser 登录信息
     */
//    public void setUserAgent(UserInfo loginUser)
//    {
